        ...
        const display = (
            <div className="favor-create-form">
                ...
                <form id={"favor-form"}>
                    ...
                    <label>
                            <textarea className="form-input"  id="favor-description" type='text' placeholder="Description" value={this.state.favor_description} onChange={this.handleInput('favor_description')} />
                    </label>
                    <br/>
